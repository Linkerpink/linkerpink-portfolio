  ...
  return (
    <div className="min-h-screen relative px-6" style={{ color: textColor }}>
      ...
      <header className="mb-10 flex flex-col md:flex-row gap-4 items-center">
        ...
        <div
          className={`flex-1 ${cardBgClass} rounded-3xl p-5 ${
            theme === "secret" ? "border-4 border-pink-400" : ""
          }`}
        >
          <div className="flex flex-col md:flex-row items-center md:items-center gap-4">
            ...
            <div className="flex flex-col items-center md:items-start text-center md:text-left">
              ...
              <p
                className="text-sm mt-2 user-select-none select-none"
        ...
        {(project.href || project.github) && (
          <div
            className={`w-full md:w-[250px] shrink-0 ${cardBgClass} rounded-3xl p-6 flex flex-col gap-4 self-center ${
              theme === "secret" ? "border-4 border-pink-400" : ""
            }`}
          >
            ...
            {project.href && (
              <a
                ...
                className={`flex items-center gap-3 px-2.5 py-2 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 text-white font-semibold interactable-object select-none ${
                  theme === "secret" ? "ring-2 ring-pink-400" : ""
                }`}
                draggable={false}
              >
                <Image
      ...
      {sortedMedia.length > 0 && (
        <section className="mb-12">
          ...
          <hr
            ...
            style={{ borderColor: hrBorderColor }}
          />
          <div className="flex flex-wrap justify-center gap-3">
            {mediaWithIndex.map((mediaItem, i) => {
              ...
              const typeLabel =
                labelMap[mediaItem.type as string] ||
      ...
      <section className="mb-10">
        ...
        />
        <div
          className={`${cardBgClass} rounded-3xl p-6 ${
            theme === "secret" ? "border-4 border-pink-400" : ""
          }`}
        >
          <p
        ...
        {project.codeSnippets && project.codeSnippets.length > 0 && (
          <section className="mb-8">
            {project.codeSnippets.map((snippet, i) => {
              const typed: CodeSnippet = snippet;
              const {
                language,
                name,
                description,
              ...
              return (
                <div key={i} className="mb-6 rounded-md overflow-hidden">
                  <CodeBlock
                    language={language}
                    name={name}
