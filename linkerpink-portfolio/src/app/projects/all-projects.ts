...
export const allProjects = [
  ...
  // Robo Rebellion: Dawn of the Machine //
  {
    ...
    icon: "/images/game icons/robo rebellion icon.webp",
    date: "2024-07-10",
...
public void SetVolume(float _volume, string _name)
{
  ...
  // When Time Collides //
  {
    ...
    icon: "/images/game icons/when time collides icon.webp",
    date: "2022-03-18",
...
// SHMUP 2 (traumatic flashbacks) //
{
  ...
  icon: "/images/game icons/shmup 2 icon.webp",
...
`,
    ...
    // Not Not Balatro (even more traumatic flashbacks) //
    {
      ...
      icon: "/images/game icons/not not balatro icon.webp",
